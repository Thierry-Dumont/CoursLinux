...
%
\title{Linux au temps du couvre-feu}
\author{Thierry Dumont \textsl{pour} l'ALDIL}
\date{\today}
%
\newcommand{\com}[1]{\texttt{cmd>#1}}
\newcommand{\comcen}[1]{\begin{center}\texttt{cmd>#1}\end{center}}
...
à faire:
\begin{itemize}
\item Introduction historique, tout est fichiers
\item Arbres
\end{itemize}
